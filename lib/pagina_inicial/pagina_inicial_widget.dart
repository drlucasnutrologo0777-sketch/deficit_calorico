...
/// Create a mobile-first authentication screen for a luxury fitness app with
/// a dark premium UI.
///
/// Minimalist, clean, no icons, no gradients, no neon.
///
/// Colors: background #0B0B0C, inputs #141416, primary text #FFFFFF,
/// secondary #A1A1A6, button #C6A969 with text #0B0B0C.
///
/// Layout: SafeArea, Container padding 16, SingleChildScrollView, Column,
/// align start, spacing 16, max width 600 centered.
///
/// State 1 (Login):
/// Title "Welcome Back"
/// Fields: Email, Password
/// Button: "Sign In" (full width, gold)
/// Text button: "Create Account"
///
/// State 2 (Create Account):
/// Title "Create Account"
/// Fields: Email, Password, Confirm Password
/// Button: "Create Account" (full width, gold)
/// Text button: "Back to Sign In"
///
/// Validation:
/// - Email required and valid
/// - Password min 6 characters
/// - Confirm Password must match
/// - Show simple error text below fields
///
/// Rules: one field per row, no fixed heights, single column, clean
                              ...
                              Container(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    if (fbUser != null) {
                                      await maybeCreateUser(fbUser);
                                    }
                                    UsersRecord? perfil = currentUserDocument;
                                    if (currentUserReference != null) {
                                      final snap =
                                          await currentUserReference!.get();
                                      if (snap.exists) {
                                        perfil = UsersRecord.fromSnapshot(
                                          snap,
                                        );
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      context.pushNamed(
                                          CriarLoginSenhaWidget.routeName);
                                    },
